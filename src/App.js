...
function App() {
    ...
    const [QuestionNum2, setQuestionNum2] = useState(3);
    const [QuestionNum3, setQuestionNum3] = useState(7)
    const [button, setButton] = useState("Start Survey");
    const getsurvey = async (value) => {

        let Tasks = await axios.get('http://localhost:1337/api/surveys/' + value);
        setQuestion1(Tasks.data.data[QuestionNum1]["attributes"]);
        setQuestion2(Tasks.data.data[QuestionNum2]["attributes"]);
        setQuestion3(Tasks.data.data[QuestionNum3]["attributes"]);
        setQuestionNum1(prev => QuestionNum1 + 2);
        setQuestionNum2(prev => QuestionNum2 + 2);
        setQuestionNum3(prev => QuestionNum3 + 2);
    ...
    return (
        <div className="App" >
            <div className="main">
                ...
                <div id="surv" className={page1} hidden>
                    <br />
                    ...
                    <div className="radio_option">
                        ...
                        <br /> <br />
                        <input type="radio" value="ww" name="r" className="radio" onClick={(event) => setResponse1(question1.c)} />
                        <label className="font1 magin1">{question1.c}</label>
                        <br /><br />
                    </div>
                </div>
